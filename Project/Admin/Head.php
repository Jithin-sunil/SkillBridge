        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="Homepage.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>Skill Bridge</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Category.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Skill Category</a>
                    <a href="Skill.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Skills</a>
                    <a href="UserList.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>User List</a>
                    <a href="ViewComplaints.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>View Complaints</a>
                    <a href="ViewFeedbacks.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>View Feedbacks</a>
